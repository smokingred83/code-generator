...
class Settings(BaseSettings):
    ...
    COMET_PROJECT: str = "codeGen"

    # --- Required settings when deploying the code. ---
    # --- Otherwise, default values values work fine. ---

    # MongoDB database
    DATABASE_HOST: str = "mongodb://code_generator:code_generator@127.0.0.1:27017"
    DATABASE_NAME: str = "codeGen"
    ...
    # AWS SageMaker
    HF_MODEL_ID: str = "ggallo/CodeBERT-DPO"
    ...
    SAGEMAKER_ENDPOINT_CONFIG_INFERENCE: str = "codeGen"
    SAGEMAKER_ENDPOINT_INFERENCE: str = "codeGen"
